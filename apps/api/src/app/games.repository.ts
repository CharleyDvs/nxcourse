const games = [
  {
    ...
    image: '/assets/beans.webp', // 'https://media.giphy.com/media/xUNda3pLJEsg4Nedji/giphy.gif',
    description:
  ...
  },
  {
    id: 'chess-pie',
    name: 'Chess Pie',
    image: '/assets/chess.webp', // 'https://media.giphy.com/media/iCZyBnPBLr0dy/giphy.gif',
